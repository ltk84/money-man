            ...
            children: [
              Container(
                child: CarouselSlider(
                  ...
                  items: [
                    if (reportData1 != null) ImageFromUnit8List(reportData1),
                    if (reportData2 != null) ImageFromUnit8List(reportData2),
                    if (reportData3 != null) ImageFromUnit8List(reportData3),
                  ],
                ),
              ),
              Container(
