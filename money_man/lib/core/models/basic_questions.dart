class BasicQuestions {
  ...
  BasicQuestions() {
    ...
    answers = [
      ...
      "Yes, in case you registered Money Man account. You only need to login in other devices to continue use Money Man. We support Android.",
      ...
      'Money Man supports all popular devices Android.',
    ];
  }
}
