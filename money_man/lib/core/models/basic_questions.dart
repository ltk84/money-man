class BasicQuestions {
  ...
  BasicQuestions() {
    ...
    answers = [
      ...
      "Money Man helps you keep track of your debts & loans. Let's start with the simple concept: If you borrow money form other, you need to add a Debt. It's Payable transaction. If you lend other money, you need to add a Loan. It's Receivable transaction.",
      ...
      'Money Man only supports Android devices right now.',
    ];
  }
}
